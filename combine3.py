#Combine 3 - adding dummification and removing some unnecessary categories. 
#Combine 3 onwards is also for testing added variables.
...
final_test.to_csv('te3.csv')
final_trainwithYLOG.to_csv('try3.csv')